...
# 	obj=Cryptography(10)
# 	cipher,n=obj.encrypt(text)
# 	cmdmsg=cipher+"--"+str(obj.get_private_key())+"--"+str(n)
# 	root,s=buildHuffmanTree(cmdmsg)
# 	print("Root Values : "+str(root))
# 	txt=decodeValues(root,s)
# 	#print("Final Txt : "+txt)
# 	compress,key,n=txt.split("--")
# 	print("Decompressed Text : "+obj.customDecrypt(compress,int(key),int(n)))
